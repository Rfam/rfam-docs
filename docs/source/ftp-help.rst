...
Rfam `FTP site <ftp://ftp.ebi.ac.uk/pub/databases/Rfam>`_.
...
`README <ftp://ftp.ebi.ac.uk/pub/databases/Rfam/CURRENT/README>`_
  Release Notes
`COPYING <ftp://ftp.ebi.ac.uk/pub/databases/Rfam/CURRENT/COPYING>`_
...
`Rfam.tar.gz <ftp://ftp.ebi.ac.uk/pub/databases/Rfam/CURRENT/Rfam.tar.gz>`_
  Rfam covariance models in ascii INFERNAL format
`Rfam.seed.gz <ftp://ftp.ebi.ac.uk/pub/databases/Rfam/CURRENT/Rfam.seed.gz>`_
  Annotated seed alignments in STOCKHOLM format
`Rfam.seed_tree.tar.gz <ftp://ftp.ebi.ac.uk/pub/databases/Rfam/CURRENT/Rfam.seed_tree.tar.gz>`_
  Annotated tree files for each seed alignment
`Rfam.full_region.gz <ftp://ftp.ebi.ac.uk/pub/databases/Rfam/CURRENT/Rfam.full_region.gz>`_
