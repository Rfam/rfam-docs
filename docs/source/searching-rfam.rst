...
`:new:` For more examples please see our newly published `protocols <https://currentprotocols.onlinelibrary.wiley.com/doi/full/10.1002/cpbi.51>`_ in Bioinformatics. 
