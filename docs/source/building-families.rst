...
Rfam :ref:`glossary:SEED alignment` contains a curated subset of representative sequences for each family, derived from the scientific literature, expert databases, or specialist knowledge of non-coding RNAs. The
...
The Rfam :ref:`glossary:FULL alignment` contains all of the sequences in :ref:`glossary:rfamseq` that
